      ...
      <div class="login-box">
        <form class="login-form">
          ...
          <div class="form-group">
            ...
            <input class="form-control" type="text" placeholder="Username" autofocus id="usuario" name="usuario">
          </div>
          <div class="form-group">
            <label class="control-label">CONTRASEÑA</label>
            <input class="form-control" type="password" placeholder="Password" id="contrasena"  name="contrasena">
          </div>
          <div class="form-group">
            <div class="utility">
          ...
          <div class="form-group btn-container">
            <button type="button" class="btn btn-primary submit-btn btn-block" onclick="confirmar();"><i class="fa fa-sign-in fa-lg fa-fw"></i>ENTRAR</button>
          </div>
        </form>
